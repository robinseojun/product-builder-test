          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800/80 space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
              ...
              <select
                ...
                className="bg-slate-800 border border-slate-700 text-white font-bold rounded-lg px-3 py-1.5 outline-none focus:ring-2 focus:ring-emerald-500"
              >
            ...
            <div className="flex items-center justify-center sm:justify-start gap-1.5 flex-wrap pt-2 border-t border-slate-800">
            ...
            <div className="grid grid-cols-1 gap-3">
              {savedGames.map((game, idx) => {
                ...
                return (
                  <div
                    key={game.id}
                    className="bg-slate-900 border border-slate-800 rounded-xl p-4 text-white flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-slate-700 transition-all"
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-6 h-6 rounded-md bg-slate-800 text-amber-400 font-black text-xs flex items-center justify-center">
                        {game.label || idx + 1}
                      </span>
              ...
              {topNumbers.map(({ num, count }) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <span className="text-xs text-slate-400 block font-semibold">{num}번</span>
